...
//Declare stepper parameters
int stepsPerRotation = 360; //This is assumed to be even
int rotationSpeed = 1; //RPM
...
Stepper stepper1(stepsPerRotation, dirA, dirB);
...
void loop(){
  ...
  stepper1.step(stepsPerRotation/2);
